...
NSString * const kEasyFormPreUrl           = @"https://h5.ebdan.net/ls";     //易表单预览域名
...
NSString * const kCommunityHeaderUrl       = @"http://app.eqxiu.com";   //内容社区域名


NSString * const kMallMusicID              = @"890162";         //商城音乐分类Id
NSString * const kMallFontID               = @"892012";         //商城字体分类id
...
NSString * const kMemberSpecificTemplateFormID           = @"892960";       //易表单根分类id
...
NSString * const kEasyFormPreUrl           = @"http://form.yqxiu.cn/fv";     //易表单预览域名
...
NSString * const kCommunityHeaderUrl       = @"http://app.yqxiu.cn";   //内容社区域名

NSString * const kMallMusicID              = @"894024";         //商城音乐分类Id
NSString * const kMallFontID               = @"890102";         //商城字体分类id
...
NSString * const kMemberSpecificTemplateFormID           = @"891425";       //易表单根分类id
...
NSString * const kLDMallTemplateId         = @"893757";         //海报模板id
NSString * const kLDMallFontId             = @"897506";       //海报字体-付费素材id
NSString * const kLDMallImageID            = @"897507";       //海报图片-包含付费素材id
...
//普通列表搜索code 样例：96171 图片：93401 字体：93044 音乐：93043 单页：96206 易表单：62010 海报：96207 形状：93048 视频：9111815 艺术二维码：96207,长页-93102
...
//搜索界面搜索code 样例：92201 图片：93041 字体：93044 音乐：93043 单页：93046 易表单：30410 海报：93047 形状：93048 视频：9111815,长页-93101
